            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                        ...
                        class="inline-flex items-center p-2 text-sm text-gray-800 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="/admin/berita"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Berita Kegiatan</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group hover:bg-red-600 hover:text-white">
